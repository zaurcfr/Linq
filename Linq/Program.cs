    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case "1":
                    SetColor();
                    Console.WriteLine("rhyta.com ve ya dayrep.com domenlerinde emaili olan borclulari cixartmag\n");
                    Console.ResetColor();
                    var list1 = debtors
                        .Where(d => d.Email.Contains("rhyta.com") || d.Email.Contains("dayrep.com"))
                        .ToList();
                    list1.ForEach(d => Console.WriteLine(d));
                    break;
                case "2":
                    SetColor();
                    Console.WriteLine("Yashi 26 - dan 36 - ya qeder olan borclulari cixartmag\n");
                    Console.ResetColor();
                    var list2 = debtors
                        .Where(d => d.BirthDay.Year >= 1985 && d.BirthDay.Year <= 1995)
                        .ToList();
                    list2.ForEach(d => Console.WriteLine(d));
                    break;
                case "3":
                    SetColor();
                    Console.WriteLine("Borcu 5000 - den cox olmayan borclularic cixartmag\n");
                    Console.ResetColor();
                    var list3 = debtors
                .Where(d => d.Debt <= 5000)
                .ToList();
                    list3.ForEach(d => Console.WriteLine(d));
                    break;
                case "4":
                    SetColor();
                    Console.WriteLine("Butov adi 18 simvoldan cox olan ve telefon nomresinde 2 ve ya 2 - den cox 7 reqemi olan borclulari cixartmaq\n");
                    Console.ResetColor();
                    var list4 = debtors
                .Where(d => d.FullName.Length > 18)
                .Where(d => d.Phone.Count(s => s == '7') >= 2)
                .ToList();
                    list4.ForEach(d => Console.WriteLine(d));
                    break;
                case "5":
                    SetColor();
                    Console.WriteLine("Qishda anadan olan borclulari cixardmaq\n");
                    Console.ResetColor();
                    var list5 = debtors
                .Where(d => d.BirthDay.Month == 1 || d.BirthDay.Month == 2 || d.BirthDay.Month == 12)
                .ToList();
                    list5.ForEach(d => Console.WriteLine(d));
                    break;
                case "6":
                    SetColor();
                    Console.WriteLine("Borcu, umumi borclarin orta borcunnan cox olan borclulari cixarmaq ve evvel familyaya gore sonra ise meblegin azalmagina gore sortirovka etmek\n");
                    Console.ResetColor();
                    ...
                    var list6 = debtors
                        ...
                        .ToList();
                    Console.WriteLine($"Average debt: {average}");
                    list6.ForEach(d => Console.WriteLine(d));
                    break;
                case "7":
                    SetColor();
                    Console.WriteLine("Telefon nomresinde 8 olmayan borclularin yalniz familyasin, yashin ve umumi borcun meblegin cixarmaq\n");
                    Console.ResetColor();
                    var list7 = debtors
                .Where(d => !d.Phone.Contains("8"))
                .ToList();
                    list7.ForEach(d => Console.WriteLine($"{d.FullName}\t{2020 - d.BirthDay.Year}\t{d.Debt}"));
                    break;
                case "8":
                    SetColor();
                ...
                case "9":
                    SetColor();
                    Console.WriteLine("borclulardan en coxu hansi ilde dogulubsa hemin ili cixartmaq\n");
                    Console.ResetColor();
                    var most = debtors.GroupBy(d => d.BirthDay.Year)
                ...
                .OrderByDescending(d => d.Debt)
                .Take(5).ToList();
                    list10.ForEach(d => Console.WriteLine(d));
                    break;
                case "11":
                    SetColor();
                    Console.WriteLine("Butun borcu olanlarin borcunu cemleyib umumi borcu cixartmaq\n");
                    Console.ResetColor();
                    var list11 = debtors
                .Sum(d => d.Debt);
                ...
                case "12":
                    SetColor();
                    Console.WriteLine("2ci dunya muharibesin gormush borclularin siyahisi cixartmaq\n");
                    Console.ResetColor();
                    var list12 = debtors
                .Where(d => d.BirthDay.Year <= 1945).ToList();
                    list12.ForEach(d => Console.WriteLine(d));
                    break;
                case "13":
                    SetColor();
                    Console.WriteLine("Nomresinde tekrar reqemler olmayan borclularin ve onlarin borcunun meblegin cixartmaq\n");
                    Console.ResetColor();
                    
                    break;
                case "14":
                    SetColor();
                    Console.WriteLine("Tesevvur edek ki,butun borclari olanlar bugunden etibaren her ay 500 azn pul odeyecekler.Oz ad gunune kimi borcun oduyub qurtara bilenlerin siyahisin cixartmaq\n");
                    Console.ResetColor();
                    var list14 = debtors
                .Where(d =>
                {
                    ...
                    list14.ForEach(d => Console.WriteLine(d));
                    break;
                case "15":
                    SetColor();
                    Console.WriteLine("Adindaki ve familyasindaki herflerden \"smile\" sozunu yaza bileceyimiz borclularin siyahisini cixartmaq\n");
                    Console.ResetColor();
                    var list15 = debtors
                .Where(d => d.FullName.Contains("s") && d.FullName.Contains("m") && d.FullName.Contains("i") && d.FullName.Contains("l") && d.FullName.Contains("e")).ToList();
                    list15.ForEach(d => Console.WriteLine(d));
                    break;
                default:
                    break;
            }
